...
* Шаг 1: Сайт отправляет запрос с данными в сервис –≥ сервис проверяет и валидирует данные, *конвертирует валюту в рубли по актуальному курсу, записывает данные в базу, создаёт идентификатор клиента и отдает его в ответе в формате JSON.
